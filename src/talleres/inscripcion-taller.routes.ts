...
import { InscripcionTallerSchema } from './inscripcion-taller.schema.js';
...
inscripcionTallerRoutes.post('/', validateSchema(InscripcionTallerSchema), add);
inscripcionTallerRoutes.put('/:id', validateSchema(InscripcionTallerSchema), update);
inscripcionTallerRoutes.patch('/:id', validateSchema(InscripcionTallerSchema), update);
