...
export const cabanaSchema = z.object({
  nombre: z
    ...
    .regex(/^[A-Za-zÁÉÍÓÚÑáéíóúñ0-9\s\-\:\.']+$/, 'Letras, números, espacios y algunos símbolos permitidos'),
...
export const cabanaUpdateSchema = cabanaSchema.partial().refine((data) => Object.keys(data).length > 0, {
